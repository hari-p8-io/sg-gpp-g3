  ...
  enrichMessage = async (call: grpc.ServerUnaryCall<EnrichmentGrpcRequest, EnrichmentGrpcResponse>, callback: grpc.sendUnaryData<EnrichmentGrpcResponse>) => {
    ...
    try {
      ...
      const grpcResponse: EnrichmentGrpcResponse = {
        ...
        kafka_published: serviceResponse.kafkaPublished || false, // NEW: Include Kafka publishing status
        pacs002_published: serviceResponse.pacs002Published || false, // NEW: Include PACS.002 response status
